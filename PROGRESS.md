...
- [x] 3.24a. Визуальный конструктор формул: палитра кнопок-шаблонов в диалоге формулы (структуры: дробь/корень/степень/индекс/сумма/произв./интеграл/lim/скобки/матрица/вектор; греческие; операторы) — вставляют LaTeX-сниппет в позицию курсора с плейсхолдером-кареткой (lib/equationSnippets.applySnippet).
