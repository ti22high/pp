...
- [x] 3.17. Polyline (режим «Ломаная»: клики добавляют вершины, превью до курсора, Enter/двойной клик — завершить, Esc — отмена) + Arc (кнопка «Дуга» вставляет дуговой path).
